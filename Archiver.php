...
class Archiver extends \Piwik\Plugin\Archiver
{
     ...
     */
    const SHORTCODETRACKER_ARCHIVE_RECORD = "ShortcodeTracker_archive_record";
    ...
    public function aggregateDayReport()
    {
         ...
         * $this->getProcessor()->insertBlobRecord(self::SHORTCODETRACKER_ARCHIVE_RECORD, $visitorReport);
         */
    }
    ...
    public function aggregateMultipleReports()
    {
         ...
         *
         * $this->getProcessor()->aggregateDataTableRecords(self::SHORTCODETRACKER_ARCHIVE_RECORD);
         */
    }
}
