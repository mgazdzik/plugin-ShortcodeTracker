...
namespace Piwik\Plugins\ShortcodeTracker\Widgets;
 ...
 */
class GetShortcodegenerator extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         * your own category.
         */
        $config->setCategoryId('Shortcodes');

        /**
         * Set the subcategory the widget belongs to. If a subcategory is set, the widget will be shown in the UI.
         */
        $config->setSubcategoryId('ShortcodeTracker_menu_generateShortcode');

        /**
         * Set the name of the widget belongs to.
         */
        $config->setName('ShortcodeTracker_Shortcodegenerator');
     ...
     * As long as you return a string everyting is fine. You can use for instance a "Piwik\View" to render a
     * twig template. In such a case don't forget to create a twig template (eg. myViewTemplate.twig) in the
     * "templates" directory of your plugin.h
     *
     * @return string
     */
